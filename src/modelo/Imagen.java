...
public class Imagen extends Contenido {
    ...
    //Metodos
public Imagen(int id, String nombre, int tipo_archivo,FileInputStream archivo, String ubicacion, int entidad, 
        int entidad_id, int aporte, int aporte_id,int area_falla,int tipo_falla, int usuario_id,int fabricante_id,
        int lineaproducto_id, int modelo_id,int Version_id ) {
